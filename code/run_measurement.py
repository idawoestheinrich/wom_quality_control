...
scan = WOMqc(
    ...
    WOMname = "WOM_FreiburgXT2mm_thin_coating_heatup_test_4",#"WOM_FreiburgXT2mm_6_55mm_new_cover_thin_coating_wo_coupling",#testbeam_WOM_16_6_55mm_vertical_steps_4",
    ...
    heatup_roomtemp = 26.1,#if no heatup == False else number of minutes
    plot_waveform = False,
    plot_heatmap = True,
    dry_run = False,
